...
public class UserControllerTest {
    ...
    void createUserWithNoEmail() throws Exception {
        ...
        assertThat(conflictException.getMessage(),
                equalTo("could not execute statement; SQL [n/a]; constraint [email\\\" of relation" +
                        " \\\"users]; nested exception is org.hibernate.exception.ConstraintViolationException:" +
